...
path = "G:\prod_task"
filename = "EXPORT"
namefile = "Production_Model_PD6_Report_" & Left(MonthName(Month(Date)),3)& Right(Year(Date),2) &".xlsx"
...
xHttp.Open "GET", "http://192.168.161.102/excel_gen/report/pd06_model/model_pd6" & Day(Date) & ".xlsx", False
xHttp.Send
