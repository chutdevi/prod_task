...
path = "G:\prod_task"
filename = "EXPORT1"
namefile = "Summary_Production_Model_Report_" & Left(MonthName(Month(newDate)),3)& Right(Year(newDate),2) &".xlsx"
...
xHttp.Open "GET", "http://192.168.161.102/excel_gen/report/prod_model_sum/prod_model_sum" & Day(Date) & ".xlsx", False
xHttp.Send
