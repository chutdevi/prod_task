...
path = "G:\prod_task"
filename = "EXPORT1"
namefile = "Production_Report_" & Left(MonthName(Month(Date)),3)& Right(Year(Date),2) &".xlsx"
...
xHttp.Open "GET", "http://192.168.161.147/report/Export_report/Prod_report_sum/prod_report" & Day(Date) & ".xlsx", False
xHttp.Send
