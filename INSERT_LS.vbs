...
Set file = fso.OpenTextFile( path & "\work\PROD_DAT_LAST.sql", 1)
...
'ej.connectionstring = "Driver={MySQL ODBC 8.0 Driver}; Data Source=DataMysql; User=monty; Password=some_pass;"
ej.open
ej.Execute("TRUNCATE PROD_MODEL")
Set sql_sv = cn.Execute(content)

Set file = fso.OpenTextFile( path & "\work\PROD_INS.sql", 1)
content = file.ReadAll
	   Do Until sql_sv.eof
				options = content
